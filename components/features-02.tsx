      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-16 md:pt-32">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            ...
            <p className="text-lg text-slate-400">Faster Turn around Times, Unlimited Throughput, Higher Quality output with lower costs.</p>
          </div>
                      ...
                      <div className="md:max-w-[480px] shrink-0 order-1 md:order-none p-6 pt-0 md:p-8 md:pr-0">
                        <div className="mb-5">
                          <div>
                            ...
                            <p className="text-slate-400">All customer data stays within the customer cloud.  Any Human-In-The-Loop process goes to a SOC-2 certified company owned data annotation center tightly integrated with the software.</p>
                          </div>
                        </div>
                        <div>
                  ...
                  <div className="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                    <div className="flex flex-col">
                      ...
                      <div className="md:max-w-[480px] shrink-0 order-1 md:order-none p-6 pt-0 md:p-8">
                        <div>
                          <h3 className="inline-flex text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-1">Elastic Scale</h3>
                          <p className="text-slate-400">Dial up and down the volume on demand.  Your customer volume changes, but with elastic scale, altering your AI business process workload does not invove continous right-sizeing of the workforce.</p>
                        </div>
                      </div>
                      {/* Image */}
                    ...
                    <div className="flex flex-col">
                      ...
                      <div className="md:max-w-[480px] shrink-0 order-1 md:order-none p-6 pt-0 md:p-8">
                        <div>
                          ...
                          <p className="text-slate-400">From Customer Support, and Sales Development, to softare integration engineering and legal reviews, the options are infinite on our flexible AI platform.</p>
                        </div>
                      </div>
                      {/* Image */}
                      <div className="relative w-full h-64 md:h-auto overflow-hidden md:pb-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 md:gap-12">
            ...
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-50">AI First</h4>
              </div>
              <p className="text-sm text-slate-400">Use Prompts, RAG, Fine-Tuning, Pipelines, Agents and Compound AI to fully automate your workflow</p>
            </div>
            {/* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-50">Evals</h4>
              </div>
              <p className="text-sm text-slate-400">Use Evals mid-pipeline to test llm chain output and ensure that you are getting the required level of quality</p>
            </div>
            {/* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
              ...
              <p className="text-sm text-slate-400">Use Human in the Loop to bridge the gap between acuracy needed and acuracy deliverable with AI; Always get top end quality from the platform.</p>
            </div>
